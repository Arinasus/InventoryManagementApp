        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlockedByUser = table.Column<string>(type: "text", nullable: true),
                    PrefferedLanguage = table.Column<string>(type: "text", nullable: false),
                    PrefferendTheme = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemsFieldValues", x => x.Id);
                    table.ForeignKey(
